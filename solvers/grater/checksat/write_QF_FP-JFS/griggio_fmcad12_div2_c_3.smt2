...
(define-fun b20 () (_ FloatingPoint 8 24) (fp #b0 #b01111111 #b01110111001011100110011))
(define-fun b11 () (_ FloatingPoint 8 24) (fp #b0 #b10000001 #b11000011010100000111100))
(define-fun b10 () (_ FloatingPoint 8 24) (fp #b0 #b10000011 #b11100001001101110111010))
(define-fun b17 () (_ FloatingPoint 8 24) (fp #b0 #b10000001 #b00001010101000010101000))
(define-fun b14 () (_ FloatingPoint 8 24) (fp #b0 #b01111111 #b00100011101101110110011))
