...
(define-fun b137 () (_ FloatingPoint 11 53) (fp #b1 #b10000000100 #b1000111101011100100000101011011100100110010011001010))
(define-fun b333 () (_ FloatingPoint 8 24) (fp #b0 #b10000001 #b10010001000101000100010))
(define-fun b338 () (_ FloatingPoint 8 24) (fp #b0 #b10000001 #b01010010000010101111000))
(define-fun b95 () (_ FloatingPoint 11 53) (fp #b0 #b01111111111 #b1100011001010111011111101100000000100100110111011101))
(define-fun b63 () (_ FloatingPoint 8 24) (fp #b0 #b10000001 #b01000000101101001111101))
(define-fun b104 () (_ FloatingPoint 11 53) (fp #b0 #b10000000011 #b0101110011010100001011111010111110010111000001011101))
(define-fun b367 () (_ FloatingPoint 8 24) (fp #b0 #b01111111 #b11000101001010101011000))
(define-fun b72 () (_ FloatingPoint 8 24) (fp #b1 #b10000101 #b10001101110111010001010))
(define-fun b120 () (_ FloatingPoint 11 53) (fp #b1 #b10000000100 #b1010000000011010010100000010010011100110110010100001))
(define-fun b219 () (_ FloatingPoint 8 24) (fp #b0 #b10000001 #b00000011111000110110110))
(define-fun b321 () (_ FloatingPoint 8 24) (fp #b0 #b10000000 #b10010110001100111111001))
(define-fun b357 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b11111000010100011101010))
(define-fun b222 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b10010101001001110100111))
(define-fun b323 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b10001110101101011000011))
(define-fun b328 () (_ FloatingPoint 8 24) (fp #b0 #b10000001 #b10110000110011100101100))
(define-fun b82 () (_ FloatingPoint 11 53) (fp #b0 #b10000000101 #b0001110001110111110000110100010011000100010100010111))
(define-fun b347 () (_ FloatingPoint 8 24) (fp #b0 #b01111101 #b10011100100110101101100))
(define-fun b154 () (_ FloatingPoint 11 53) (fp #b0 #b10000000011 #b1110111001110010100100001111010101011001100000011101))
(define-fun b362 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b00000101000110111011000))
(define-fun b316 () (_ FloatingPoint 8 24) (fp #b1 #b10000001 #b01000000110011000000110))
(define-fun b65 () (_ FloatingPoint 8 24) (fp #b0 #b10000101 #b10000110100010110010110))
(define-fun b352 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b11111011101110010110100))
