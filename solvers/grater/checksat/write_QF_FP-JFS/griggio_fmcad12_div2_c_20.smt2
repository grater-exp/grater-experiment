...
(define-fun b17 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b11101011110110110000010))
(define-fun b14 () (_ FloatingPoint 8 24) (fp #b1 #b01111111 #b10111110000101001011110))
(define-fun b11 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b00000101101100000100010))
(define-fun b62 () (_ FloatingPoint 8 24) (fp #b1 #b01111111 #b01011000101101101010010))
(define-fun b26 () (_ FloatingPoint 8 24) (fp #b0 #b01111100 #b10011100010110110001110))
(define-fun b50 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b01111101000101011101011))
(define-fun b35 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b11010111010011000001000))
(define-fun b68 () (_ FloatingPoint 8 24) (fp #b1 #b01111111 #b00000011011111111001010))
(define-fun b23 () (_ FloatingPoint 8 24) (fp #b1 #b10000001 #b00000010100010001001111))
(define-fun b47 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b01101000011110100011111))
(define-fun b71 () (_ FloatingPoint 8 24) (fp #b1 #b10000001 #b00101011001011101000001))
(define-fun b20 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b00011101010100001111000))
(define-fun b65 () (_ FloatingPoint 8 24) (fp #b0 #b01110011 #b11101001110010001111100))
(define-fun b38 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b11111100100100100111001))
(define-fun b53 () (_ FloatingPoint 8 24) (fp #b1 #b01111100 #b00101011000001100010011))
(define-fun b56 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b01111100011000100010111))
(define-fun b29 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b01000110110000001011001))
(define-fun b44 () (_ FloatingPoint 8 24) (fp #b1 #b01111111 #b01100010001000101001010))
(define-fun b41 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b11010010110010001101001))
(define-fun b10 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b10101111100101101010111))
(define-fun b59 () (_ FloatingPoint 8 24) (fp #b1 #b01111011 #b01100011111100100110001))
(define-fun b32 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b10100000001100110001101))
