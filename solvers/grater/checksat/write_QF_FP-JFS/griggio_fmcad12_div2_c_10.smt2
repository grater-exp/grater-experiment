...
(define-fun b38 () (_ FloatingPoint 8 24) (fp #b0 #b01111010 #b10001110110011010010111))
(define-fun b26 () (_ FloatingPoint 8 24) (fp #b1 #b01111101 #b00101101101001000110111))
(define-fun b14 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b10000001101111000010010))
(define-fun b29 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b01110010111001011101101))
(define-fun b35 () (_ FloatingPoint 8 24) (fp #b0 #b01111010 #b10100011111011000001101))
(define-fun b20 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b01100110000001100101000))
(define-fun b17 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b00111110110001111001001))
(define-fun b10 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b01101011101110001100001))
(define-fun b32 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b01110011101101011100011))
(define-fun b11 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b00111100010101011000011))
(define-fun b41 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b10000000101111000011000))
(define-fun b23 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b01001111010011101110111))
