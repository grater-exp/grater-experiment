...
(define-fun b38 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b01101000100100111100100))
(define-fun b26 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b01011101101010111001110))
(define-fun b14 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b01010110000111100111011))
(define-fun b29 () (_ FloatingPoint 8 24) (fp #b0 #b01111011 #b10100011110001110011100))
(define-fun b35 () (_ FloatingPoint 8 24) (fp #b0 #b01111000 #b01010001110101100110010))
(define-fun b20 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b00011100010010000000110))
(define-fun b17 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b11001110100000010000000))
(define-fun b10 () (_ FloatingPoint 8 24) (fp #b0 #b10001000 #b10001001100100000001001))
(define-fun b32 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b00101001101011111010010))
(define-fun b11 () (_ FloatingPoint 8 24) (fp #b0 #b10001000 #b00010000111001110000101))
(define-fun b41 () (_ FloatingPoint 8 24) (fp #b1 #b10000000 #b11100001001100100011010))
(define-fun b23 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b00010001110000001011000))
