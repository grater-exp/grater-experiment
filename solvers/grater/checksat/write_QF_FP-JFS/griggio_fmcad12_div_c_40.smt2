...
(define-fun b14 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b11100001111111011101111))
(define-fun b10 () (_ FloatingPoint 8 24) (fp #b0 #b01111111 #b01101010000011101001000))
(define-fun b38 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b10001101110110101011101))
(define-fun b41 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b00110100001111100110101))
(define-fun b107 () (_ FloatingPoint 8 24) (fp #b0 #b10000101 #b01110010000101100000111))
(define-fun b68 () (_ FloatingPoint 8 24) (fp #b0 #b10000011 #b01010101101000010101101))
(define-fun b95 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b00101000001100101110101))
(define-fun b83 () (_ FloatingPoint 8 24) (fp #b0 #b10000000 #b00100100100011001011011))
(define-fun b98 () (_ FloatingPoint 8 24) (fp #b0 #b10000010 #b01010100101001010101000))
(define-fun b89 () (_ FloatingPoint 8 24) (fp #b0 #b10000010 #b01011110101100110100000))
(define-fun b219 () (_ FloatingPoint 8 24) (fp #b0 #b10000110 #b00001011110010001001101))
(define-fun b35 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b00100100111001100101111))
(define-fun b23 () (_ FloatingPoint 8 24) (fp #b0 #b10000101 #b01011011001100011100001))
(define-fun b44 () (_ FloatingPoint 8 24) (fp #b0 #b10000001 #b10111000110001010111101))
(define-fun b65 () (_ FloatingPoint 8 24) (fp #b0 #b10000101 #b01110110001001000001001))
(define-fun b47 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b01111001110001110100010))
(define-fun b128 () (_ FloatingPoint 8 24) (fp #b0 #b10000010 #b10100000010000100111101))
(define-fun b20 () (_ FloatingPoint 8 24) (fp #b0 #b10000011 #b01001100110111010010011))
(define-fun b59 () (_ FloatingPoint 8 24) (fp #b0 #b10000101 #b00010111010001001111110))
(define-fun b119 () (_ FloatingPoint 8 24) (fp #b0 #b10000001 #b11110001100110010011100))
(define-fun b110 () (_ FloatingPoint 8 24) (fp #b0 #b10000010 #b00100111010110001100100))
(define-fun b17 () (_ FloatingPoint 8 24) (fp #b0 #b10000011 #b01100001010011110111010))
(define-fun b131 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b10001011110001010101001))
(define-fun b50 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b01000100111010110100110))
(define-fun b62 () (_ FloatingPoint 8 24) (fp #b0 #b10000001 #b01111000011101011101101))
(define-fun b92 () (_ FloatingPoint 8 24) (fp #b0 #b10000101 #b01110111100110000101011))
(define-fun b71 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b10000110000100010111111))
(define-fun b74 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b00101000011111001000101))
(define-fun b29 () (_ FloatingPoint 8 24) (fp #b0 #b10000101 #b01011001101011111011000))
(define-fun b104 () (_ FloatingPoint 8 24) (fp #b0 #b10000011 #b01100101001010100000110))
(define-fun b101 () (_ FloatingPoint 8 24) (fp #b0 #b10000011 #b00010010110110100111111))
(define-fun b11 () (_ FloatingPoint 8 24) (fp #b0 #b10000101 #b00101011011101110001100))
(define-fun b56 () (_ FloatingPoint 8 24) (fp #b0 #b01111111 #b10110011001111101001110))
(define-fun b116 () (_ FloatingPoint 8 24) (fp #b0 #b01111111 #b01101100011000010001110))
(define-fun b32 () (_ FloatingPoint 8 24) (fp #b0 #b01111111 #b00101110110011110110111))
(define-fun b125 () (_ FloatingPoint 8 24) (fp #b0 #b10000101 #b00101001100011101011010))
(define-fun b77 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b01111101111011001001111))
(define-fun b53 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b01000110101100111101100))
(define-fun b113 () (_ FloatingPoint 8 24) (fp #b0 #b10000010 #b01110111100001000010101))
(define-fun b80 () (_ FloatingPoint 8 24) (fp #b1 #b01111110 #b10001101100010101100111))
(define-fun b122 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b10111100111001100100100))
(define-fun b86 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b00101010010000000111001))
(define-fun b26 () (_ FloatingPoint 8 24) (fp #b0 #b01111111 #b00011100010101101000101))
