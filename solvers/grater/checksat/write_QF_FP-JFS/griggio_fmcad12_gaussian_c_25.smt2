...
(define-fun b283 () (_ FloatingPoint 8 24) (fp #b1 #b10000101 #b01010000110010010000010))
(define-fun b413 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b10110011110010001000110))
(define-fun b900 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b11111000001000011111110))
(define-fun b166 () (_ FloatingPoint 8 24) (fp #b1 #b10000100 #b10011001110111101011010))
(define-fun b189 () (_ FloatingPoint 8 24) (fp #b1 #b10000101 #b01110011011000010000110))
(define-fun b296 () (_ FloatingPoint 8 24) (fp #b0 #b10000101 #b00101010001001010101101))
(define-fun b890 () (_ FloatingPoint 8 24) (fp #b0 #b01111111 #b10111100100110100010010))
(define-fun b387 () (_ FloatingPoint 8 24) (fp #b0 #b10000101 #b01011011001010100000000))
(define-fun b910 () (_ FloatingPoint 8 24) (fp #b0 #b01111011 #b00010010110001110101010))
(define-fun b865 () (_ FloatingPoint 8 24) (fp #b0 #b01111011 #b01011100100110001001011))
(define-fun b400 () (_ FloatingPoint 8 24) (fp #b1 #b10000101 #b00010001111110111111000))
(define-fun b930 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b01011001001001111100111))
(define-fun b423 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b01111100101010010100111))
(define-fun b384 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b10100011000101011100100))
(define-fun b965 () (_ FloatingPoint 8 24) (fp #b0 #b01111100 #b00100101011011011111010))
(define-fun b267 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b01100001100011010101010))
(define-fun b244 () (_ FloatingPoint 8 24) (fp #b1 #b10000010 #b10001010110111111011111))
(define-fun b205 () (_ FloatingPoint 8 24) (fp #b1 #b10000101 #b01011011001001011100000))
(define-fun b465 () (_ FloatingPoint 8 24) (fp #b0 #b10000011 #b11110111110010011000111))
(define-fun b439 () (_ FloatingPoint 8 24) (fp #b0 #b10000010 #b01000011011010111000111))
(define-fun b970 () (_ FloatingPoint 8 24) (fp #b0 #b01111111 #b00111000111001000010100))
(define-fun b306 () (_ FloatingPoint 8 24) (fp #b0 #b10000010 #b11001011010100001010111))
(define-fun b136 () (_ FloatingPoint 8 24) (fp #b0 #b01111000 #b00101010111010011100110))
(define-fun b436 () (_ FloatingPoint 8 24) (fp #b1 #b10000011 #b11101010000000010011100))
(define-fun b192 () (_ FloatingPoint 8 24) (fp #b0 #b10000001 #b11011010000011111000011))
(define-fun b875 () (_ FloatingPoint 8 24) (fp #b0 #b01111101 #b11111011101010101111111))
(define-fun b345 () (_ FloatingPoint 8 24) (fp #b1 #b10000100 #b01000011100011110010011))
(define-fun b159 () (_ FloatingPoint 8 24) (fp #b0 #b10000011 #b10111111001010100111111))
(define-fun b452 () (_ FloatingPoint 8 24) (fp #b1 #b10000011 #b10101000101011101010010))
(define-fun b426 () (_ FloatingPoint 8 24) (fp #b0 #b10000010 #b00111100011101001001001))
(define-fun b361 () (_ FloatingPoint 8 24) (fp #b0 #b10000011 #b11011111111111110000010))
(define-fun b955 () (_ FloatingPoint 8 24) (fp #b0 #b01111101 #b01110111111100101101111))
(define-fun b335 () (_ FloatingPoint 8 24) (fp #b1 #b10000101 #b01101100110101011001101))
(define-fun b218 () (_ FloatingPoint 8 24) (fp #b1 #b10000100 #b01001111111111110110000))
(define-fun b270 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b01011000011001010110110))
(define-fun b241 () (_ FloatingPoint 8 24) (fp #b1 #b10000001 #b01001111001001100100110))
(define-fun b935 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b00111011010111101111010))
(define-fun b905 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b11001100101011100101111))
(define-fun b148 () (_ FloatingPoint 8 24) (fp #b0 #b10000011 #b01000100100101010100101))
(define-fun b880 () (_ FloatingPoint 8 24) (fp #b0 #b01111100 #b10101010111011000110010))
(define-fun b202 () (_ FloatingPoint 8 24) (fp #b1 #b10000011 #b10010010100110000111011))
(define-fun b397 () (_ FloatingPoint 8 24) (fp #b1 #b10000100 #b00010011001101111100010))
(define-fun b254 () (_ FloatingPoint 8 24) (fp #b1 #b10000101 #b00001101011101110010000))
(define-fun b945 () (_ FloatingPoint 8 24) (fp #b0 #b01111010 #b00101001001110011110110))
(define-fun b950 () (_ FloatingPoint 8 24) (fp #b0 #b01111100 #b10011011011000001010000))
(define-fun b885 () (_ FloatingPoint 8 24) (fp #b0 #b01111111 #b01100001111001000110100))
(define-fun b975 () (_ FloatingPoint 8 24) (fp #b0 #b01111111 #b00000001010100000110100))
(define-fun b410 () (_ FloatingPoint 8 24) (fp #b1 #b10000100 #b01000101011111010110110))
(define-fun b348 () (_ FloatingPoint 8 24) (fp #b0 #b10000101 #b01011100001100010000100))
(define-fun b915 () (_ FloatingPoint 8 24) (fp #b0 #b01111100 #b00100011110111110001110))
(define-fun b309 () (_ FloatingPoint 8 24) (fp #b1 #b10000100 #b01011001111011101010100))
(define-fun b215 () (_ FloatingPoint 8 24) (fp #b0 #b10000011 #b01111111101011010100010))
(define-fun b462 () (_ FloatingPoint 8 24) (fp #b1 #b10000101 #b01011010011001101000111))
(define-fun b860 () (_ FloatingPoint 8 24) (fp #b0 #b01111100 #b00011011011111101001111))
(define-fun b163 () (_ FloatingPoint 8 24) (fp #b0 #b10000101 #b10000101100011110000001))
(define-fun b332 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b11000010110011110100110))
(define-fun b371 () (_ FloatingPoint 8 24) (fp #b0 #b10000101 #b00110001000110110000001))
(define-fun b610 () (_ FloatingPoint 8 24) (fp #b1 #b10000010 #b01101000001100010010000))
(define-fun b960 () (_ FloatingPoint 8 24) (fp #b0 #b01111101 #b11111101110000000000101))
(define-fun b870 () (_ FloatingPoint 8 24) (fp #b0 #b01111101 #b11010010011010011010101))
(define-fun b151 () (_ FloatingPoint 8 24) (fp #b0 #b10000101 #b00101001010110001000100))
(define-fun b280 () (_ FloatingPoint 8 24) (fp #b1 #b10000010 #b11001111001001011010010))
(define-fun b293 () (_ FloatingPoint 8 24) (fp #b1 #b10000101 #b00100010000010110110000))
(define-fun b940 () (_ FloatingPoint 8 24) (fp #b0 #b01111001 #b10001011000110001010000))
(define-fun b176 () (_ FloatingPoint 8 24) (fp #b1 #b10000100 #b11100010110011101000000))
(define-fun b449 () (_ FloatingPoint 8 24) (fp #b1 #b10000100 #b11100110001100111101110))
(define-fun b322 () (_ FloatingPoint 8 24) (fp #b1 #b10000011 #b10011010001100100001010))
(define-fun b374 () (_ FloatingPoint 8 24) (fp #b0 #b10000101 #b01011111110010111001000))
(define-fun b179 () (_ FloatingPoint 8 24) (fp #b1 #b10000010 #b00011001011001011110101))
(define-fun b146 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b01001001111100011000010))
(define-fun b228 () (_ FloatingPoint 8 24) (fp #b1 #b10000010 #b10000000101101011111000))
(define-fun b319 () (_ FloatingPoint 8 24) (fp #b1 #b10000100 #b10000010010001001010101))
(define-fun b895 () (_ FloatingPoint 8 24) (fp #b0 #b01111100 #b11110010110101001000100))
(define-fun b257 () (_ FloatingPoint 8 24) (fp #b0 #b10000100 #b10100001001001000101100))
(define-fun b231 () (_ FloatingPoint 8 24) (fp #b1 #b10000100 #b00111100010010010110011))
(define-fun b925 () (_ FloatingPoint 8 24) (fp #b0 #b01111101 #b01011011110111101010001))
(define-fun b920 () (_ FloatingPoint 8 24) (fp #b0 #b01111110 #b11101111001001100111000))
(define-fun b134 () (_ FloatingPoint 8 24) (fp #b1 #b10000010 #b01100001010111101000100))
(define-fun b358 () (_ FloatingPoint 8 24) (fp #b1 #b10000100 #b01000110011111011010100))
