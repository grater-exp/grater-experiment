...
# 创建存储文件夹（如果不存在）
mkdir -p /root/output/output-500-48h/coverme

# 指定输出的结果文件路径
result_file="/root/output/output-500-48h/coverme/result-48h.csv"
...
# 指定分类文件
select_files="$experiment_dir/select-48h-coverme.csv"
